...
3. Created a new PostgreSQL database for the project.
4. Configured database connection settings.
...
* pgAdmin provided a user-friendly interface for database management.
